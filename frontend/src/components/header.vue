<template>
    <header class="fixed left-0 top-0 z-40 border-b w-full bg-gray-50 dark:bg-neutral-900">
        <nav
        ...
        >
            ...
            <div class="justify-end flex py-5">
                <router-link v-if="!user || Object.keys(user).length === 0" to="/login" title="Login">
                ...
                <router-link v-if="Object.keys(user).length > 0 && !hideProfileIcon" to="/profile" title="Profile">
                    <div class="icon-container">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
